...
## 2025
* TBD: The configuration is now processed into a more standardized format for internal workflow usage. The raw and processed configuration are written to `results/config_raw.yaml` and `results/config_processed.yaml` respectively. [#X][]
